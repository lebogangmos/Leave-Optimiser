...
// // const apiKey = 'aI4Xz1jxcXqhaPmLwnxYFbYmkj7EqMr4';
// const holidayApiUrl = 'https://date.nager.at/Api/v3/PublicHolidays/';

// // Fetch holidays based on selected country and year
// async function fetchHolidays(countryCode, year) {
//     const url = `${holidayApiUrl}${year}/${countryCode}`;
...
// // Optimize leave days based on holidays and user input
// function optimizeLeaveDays(holidays, leaveDays) {
//     let optimizedLeave = [];
//     let remainingLeaveDays = leaveDays;

//     // Sort holidays by date
//     holidays.sort((a, b) => new Date(a.date.iso) - new Date(b.date.iso)); // Updated to use 'date.iso' format

//     // Loop through holidays to suggest the best days for leave
//     holidays.forEach(holiday => {
//         let holidayDate = new Date(holiday.date.iso); // Use the correct date format from the API response
...
//         // Check if user has enough leave days and if they are workdays
...
//     return optimizedLeave; // Corrected typo: 'optimizeLeave' -> 'optimizedLeave'
// }

// // Display optimized leave suggestions
// function displayedSuggestions(leaveDays) {
...
// document.querySelector('.js-optimize-btn').addEventListener("click", async (event) => {
//     event.preventDefault(); // Prevent form from submitting

//     const countryCode = document.getElementById('countryCode').value;
//     const year = document.getElementById('year').value;
//     const leaveDays = parseInt(document.getElementById('leave-days').value, 10); // Ensure leaveDays is a number

//     // Fetch holidays from API
//     const holidays = await fetchHolidays(countryCode, year);
//     console.log("Optimized Holidays Data:", holidays);

//     // Optimize leave days based on holidays
//     const optimizedLeave = optimizeLeaveDays(holidays, leaveDays);

//     // Display optimized leave suggestions
//     displayedSuggestions(optimizedLeave);
// });
